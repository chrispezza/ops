...
export const METRIC_LABELS: Record<string, string> = {
  ...
  "prs.open": "open PRs",
  "prs.oldest_days": "oldest human PR",
  "prs.dependabot_count": "Dependabot PRs",
  "prs.dependabot_major": "Dependabot major bumps",
  "issues.idle_90d": "idle issues 90d+",
  "issues.new_7d": "new issues 7d",
  "issues.oldest_days": "oldest issue",
  "issues.flagged": "flagged issues",
  "issues.cards": "issue cards",
  "issues.closed_7d": "issues closed 7d",
  "prs.cards": "PR cards",
  "prs.merged_7d": "PRs merged 7d",
